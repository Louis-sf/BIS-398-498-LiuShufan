...
#coming from the human and which are coming from the computer, then
#it’s reasonable to say that the computer is exhibiting intelligence.
#Create a script that plays the part of the independent computer, giving its
...
#Would this conversation convince the user that the entity at the other end
#exhibited intelligent behavior? Why or why not?# -*- coding: utf-8 -*-

input('What is your problem?')

while True:
    
    answers = input('Have you had this problem before (yes or no)?')
    ...
    if answers == "yes":
        ...
        print('please reenter with only yes or no')
        
#The conversation is not convincing because it is easier for the machine 
#to respond to binary and static answers